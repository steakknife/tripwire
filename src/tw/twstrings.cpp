...
#define TSS_PRODUCT_NAME _T("Open Soure Tripwire(R) 2.4.2.3.") 
...
TSS_BeginStringtable( cTW )
    ...
    TSS_StringEntry( tw::STR_REPORT_TITLE,            _T("Open Source Tripwire(R) 2.4.2.3 Integrity Check Report") ),    
	...
	TSS_StringEntry( tw::STR_DBPRINT_TITLE,			  _T("Open Source Tripwire(R) 2.4.2.3 Database") ),
